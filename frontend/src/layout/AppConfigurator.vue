...
const preset: Ref<string> = ref(layoutConfig.preset);
const presetOptions: Ref<string[]> = ref(Object.keys(presets));

const menuMode: Ref<string> = ref(layoutConfig.menuMode);
const menuModeOptions: Ref<MenuModeOption[]> = ref([
    { label: 'Static', value: 'static' },
    { label: 'Overlay', value: 'overlay' }
]);

const primaryColors: Ref<Color[]> = ref([
    { name: 'noir', palette: {} },
...
function getPresetExt(): Record<string, unknown> {
