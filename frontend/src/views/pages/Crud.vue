...
const selectedProducts: Ref<Product[] | null> = ref(null);
const filters = ref({
    global: { value: null, matchMode: FilterMatchMode.CONTAINS }
});
const submitted = ref(false);
const statuses: Ref<StatusOption[]> = ref([
...
function saveProduct(): void {
    ...
    if (product?.value.name?.trim()) {
        if (product.value.id) {
            product.value.inventoryStatus = product.value.inventoryStatus && typeof product.value.inventoryStatus === 'object' 
