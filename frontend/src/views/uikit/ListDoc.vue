...
const picklistProducts: Ref<[Product[], Product[]] | null> = ref(null);
const orderlistProducts: Ref<Product[] | null> = ref(null);
...
function getSeverity(product: Product): string | null {
