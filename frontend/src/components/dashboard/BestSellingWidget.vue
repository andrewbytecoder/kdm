...
function onMenuItemClick(event: Event, item: MenuItem): void {
}
...
<template>
    <div class="card">
        <div class="flex justify-between items-center mb-6">
            ...
            <div>
                <Button icon="pi pi-ellipsis-v" class="p-button-text p-button-plain p-button-rounded" @click="onMenuItemClick"></Button>
